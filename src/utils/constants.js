...
export const SOCIAL_PLATFORMS = [
  { name: 'Website', icon: 'ri-global-line', placeholder: 'https://example.com' },
  { name: 'Twitter', icon: 'ri-twitter-x-line', placeholder: 'https://twitter.com/username' },
  { name: 'Facebook', icon: 'ri-facebook-fill', placeholder: 'https://facebook.com/page' },
  { name: 'LinkedIn', icon: 'ri-linkedin-fill', placeholder: 'https://linkedin.com/company/name' },
  { name: 'Instagram', icon: 'ri-instagram-line', placeholder: 'https://instagram.com/username' },
  { name: 'GitHub', icon: 'ri-github-fill', placeholder: 'https://github.com/organization' },
  { name: 'Discord', icon: 'ri-discord-fill', placeholder: 'https://discord.gg/invite' },
  { name: 'Slack', icon: 'ri-slack-fill', placeholder: 'https://workspace.slack.com' },
  { name: 'Telegram', icon: 'ri-telegram-fill', placeholder: 'https://t.me/channel' },
  { name: 'WhatsApp', icon: 'ri-whatsapp-line', placeholder: 'https://chat.whatsapp.com/invite' },
  { name: 'YouTube', icon: 'ri-youtube-fill', placeholder: 'https://youtube.com/channel' }
];
...
export const CAMEROON_CITIES = [
  ...
  { name: 'Yaounde', region: 'Centre', coordinates: [11.5174, 3.8480] },
  ...
  { name: 'Garoua', region: 'North', coordinates: [13.4000, 9.3000] },
...
export const MAP_CONFIG = {
  DEFAULT_CENTER: [11.5174, 3.8480], // Yaounde coordinates
  DEFAULT_ZOOM: 6,
  MIN_ZOOM: 5,
  MAX_ZOOM: 15,
  MARKER_COLORS: {
