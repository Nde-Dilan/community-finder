...
const CommunityCard = ({ community, showTags = false }) => {
  ...
  return (
    <>
      <div
        className="min-w-[300px] bg-white rounded-lg shadow-md overflow-hidden flex-shrink-0 hover:shadow-lg transition duration-300 cursor-pointer"
      ...
      >
        ...
        <div className="p-5">
          ...
          <button
            className="w-full px-4 py-2 bg-[var(--primary)] text-white rounded-button whitespace-nowrap hover:opacity-90 transition"
            onClick={(e) => {
              e.stopPropagation();
              setIsModalOpen(true);
            }}
