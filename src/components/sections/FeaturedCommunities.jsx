      ...
      <section id="communities" className="py-16 cameroon-gradient">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-2">Featured Communities</h2>
            <p className="text-gray-600 mb-10">Discover the most active tech communities in Cameroon</p>
    ...
    <section id="communities" className="py-16 cameroon-gradient">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-10">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-2">Featured Communities</h2>
            <p className="text-gray-600">Discover the most active tech communities in Cameroon</p>
          </div>
