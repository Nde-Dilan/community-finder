...
const CommunitiesDirectory = () => {
  ...
  const { data, loading, error } = useApi(fetchCommunities, []);
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 id='communities-directory' className="text-3xl md:text-4xl font-bold mb-4">Communities Directory</h2>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Browse our comprehensive directory of tech communities across Cameroon. Filter by region, category, or search for specific groups.
          </p>
        </div>
                            ...
                            {community.tags.map((tag, index) => (
                              <span 
                                ...
                                className={`px-2 py-1 rounded text-xs ${
                                  index % 6 === 0 ? 'bg-blue-100 text-blue-800' :
                                  index % 6 === 1 ? 'bg-green-100 text-green-800' :
                                  index % 6 === 2 ? 'bg-purple-100 text-purple-800' :
                                  index % 6 === 3 ? 'bg-red-100 text-red-800' :
                                  index % 6 === 4 ? 'bg-yellow-100 text-yellow-800' :
