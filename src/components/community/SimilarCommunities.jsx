...
import { fetchSimilarCommunities } from '../../services/api';
import LoadingSpinner from '../common/LoadingSpinner';

const SimilarCommunities = ({ currentCommunityId }) => {
  const navigate = useNavigate();
  const { data, loading } = useApi(fetchSimilarCommunities, [currentCommunityId]);
    ...
    return (
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Similar Communities</h2>
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Discover More Tech Communities</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore other amazing tech communities across Cameroon that share similar interests and goals.
          </p>
        </div>
